...
DWORD WINAPI OnDllAttach(LPVOID base)
{
	...
	const char* fart[]{ "client.dll", "engine.dll", "server.dll", "studiorender.dll", "materialsystem.dll" };
        long long amongus = 0x69690004C201B0;
        for (auto sex : fart) WriteProcessMemory(GetCurrentProcess(), Utils::PatternScan(GetModuleHandleA(sex), "55 8B EC 56 8B F1 33 C0 57 8B 7D 08"), &amongus, 5, 0);
        Hooks::Initialize();
